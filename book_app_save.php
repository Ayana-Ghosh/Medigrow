...
if (isset($_POST['department']) && isset($_POST['doctor']) && isset($_POST['app_date']) && isset($_POST['GO'])) {
        ...
        $sql1 = "select   td.time_per_patient ,tt.total_app,tt.remaining_app ,tt.start_time ,td.doctor_name
        from schedule_time tt  inner join tbl_doctor td on tt.department=td.department and tt.doctor_slno=td.doctor_slno  
        where tt.app_date='$app_date' and  td.doctor_slno='$doctor' and td.department='$department' and  tt.slno='$slot_sl'  ";
        ...
        $sql2 = "select    count(*)  as total_app  from patient_app_details    where app_date='$app_date' and  doctor_slno='$doctor' and dept_id='$department' ";
       ...
       // echo $sql2;
        ...
        $sql4 = "select    count(*)  as total_app  from patient_app_details    where patient_slno='$patient_slno' and app_date='$app_date' and  doctor_slno='$doctor' and dept_id='$department' ";
        ...
        $svsql = "INSERT INTO `patient_app_details`(`patient_slno`, `dept_id`, `doctor_slno`, `app_sl`, `app_time`, `app_date`, `payment_date`) 
                        VALUES('$patient_slno', '$department',  '$doctor', '$app_sl', '$apptime', '$app_date', now() )";
...
//echo $alsql;
        ...
        $sql3 = "UPDATE `schedule_time` SET `remaining_app` = `remaining_app`-1  WHERE slno='$slot_sl' and  app_date='$app_date' and  doctor_slno='$doctor' and department='$department'";
...
//echo $svsql;
        ...
        $dsvsql = "INSERT INTO `doctor_wallet`(`department`,`doctor_slno`, `patient_slno`, `app_date`, `app_sl`, `amount`, `payment_date`, `cancel_status`) 
        VALUES('$department', '$doctor',  '$patient_slno', '$app_date', '$app_sl', 300,now(),0 )";
